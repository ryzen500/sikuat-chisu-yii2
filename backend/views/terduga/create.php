                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                             ...
                             <?=  $form->field($model, 'status_dm_id')->dropDownList($lokasiAnatomiOptions, ['id' => 'lokasi_anatomi'])->label('Status DM') ?>


                             <?=  $form->field($model, 'status_hiv_id')->dropDownList($lokasiAnatomiOptions, ['id' => 'lokasi_anatomi'])->label('Status DM') ?>
                        </div>

                        <!-- Pisah -->
            	 	   <div class="col-lg-6">
                            <?=  $form->field($model, 'terduga_tb_id')->dropDownList($lokasiAnatomiOptions, ['id' => 'lokasi_anatomi'])->label('Jenis Terduga') ?>

                             <?=  $form->field($model, 'tipe_pasien_id')->dropDownList($lokasiAnatomiOptions, ['id' => 'lokasi_anatomi'])->label('Tipe Pasien') ?>
                        </div>
